...
SpectrumBox.prototype.init = function(
  ...
  this.current = 0; //indicates the current sample in the sampling process
...
SpectrumBox.prototype.getContent = function() {
  return this.content;
}

SpectrumBox.prototype.getSamples = function() {
  return this.samples;
}
...
SpectrumBox.prototype.update = function() {
  ...
  this.samples[this.current] = new Array();
